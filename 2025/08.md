...
- 感想
  - 基礎原理には必ず背景や目的（歴史）が存在するはずで、「何のために」その原理が存在するのかを理解し、それを実践に活かすことが重要
...
#### :seedling: **メモ**
- 過去問が割と解けない・・
  - 全く理解できないわけではないけど、調べ直さないと答えまで辿りつかない
...
- 苦手なので1日一回は何かインプットをする試み
  - サバイバルTypeScriptの気になったところを読んでみる
  - [クラスのreadonly修飾子](https://typescriptbook.jp/reference/object-oriented/class/readonly-modifier-in-classes)

####  :seedling: 『プリンシプルオブプログラミング』より「アーキテクチャ根底技法」
- 良いコードには型がある
  - 根底技法
    - ある問題に対して、特定の解決策が優れているということをプログラマ達が認識し、その解決策をなん度も利用してきた
- 感想
  - 多くのプログラマが長年にわたって試行錯誤し、蓄積してきた知恵や技法を身につける
